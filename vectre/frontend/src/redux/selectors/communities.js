...
export const searchedCommunitiesSelector = createSelector(state => state && state.communities && state.communities.searched, searchedCommunitiesSelector => searchedCommunitiesSelector)
