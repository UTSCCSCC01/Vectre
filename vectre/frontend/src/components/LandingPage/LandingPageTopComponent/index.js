        ...
        >
          ...
          >
            ...
            <Text color={"sub.500"} fontSize={{ base: "18px", md: "22px" }}>
              Connect with your favourite communities, showcase your NFTs, earn
              community badges and decide the direction for your favourite
              projects!
            </Text>
            <Stack
              spacing={{ base: 4, sm: 6 }}
            ...
            >
              ...
              <Link href="#" _hover={{ textDecoration: "none" }}>
                <Button
                  ...
                  bg={"#C6DBFF"}
                  leftIcon={
                    <PlayCircleIcon h={4} w={4} mr={2} color={"#3B82F6"} />
                  }
                  _hover={{ bg: "#C6DBFFdd" }}
                  _focus={{ outline: 0 }}
                >
