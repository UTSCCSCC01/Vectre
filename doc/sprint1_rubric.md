...
## Planning Meetings (RPM.md, sprintN.md) (max 5 marks)
  ...
  - RPM.md (Release Planning Meetings) (max 3 marks)
    ...
    Your Mark: 2 - participants are not recorded
...
## Sprint Completion (Max 20 marks) 
  ...
  Your Mark: 18 / 20
  Note: No explanation provided for why one of the user story's is incomplete
...
## Sprint Demo (Max 14 marks) 
  ...
  - 0 marks = documentation has not been created
    ...
    Your Mark: 1 / 2 - frontend isnt documented enough; you can inculde description and explain usage of components that other developers would have to use
...
83 / 89
Note: Just make the title of your user story ticket the actual user story and in the description put the CoS
